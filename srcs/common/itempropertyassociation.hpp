...
public:
    ...
    ~ItemPropertyAssociation() override = default;
     ...
     * @param [in] index 1-based index of the property to associate from the Item Property Container Box. Value 0
     * indicates no property is associated.
