...
public:
    ...
    ~HevcSampleEntry() override = default;
    ...
    void createCodingConstraintsBox() override;

    /** @brief Gets the CodingConstraintsBox
     *  @return Pointer to CodingConstraintsBox, if present. */
    const CodingConstraintsBox* getCodingConstraintsBox() const override;

    /** @brief Gets the CodingConstraintsBox
     *  @return Pointer to CodingConstraintsBox, if present. */
    CodingConstraintsBox* getCodingConstraintsBox() override;
    ...
    HevcSampleEntry* clone() const override;
