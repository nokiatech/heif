...
namespace HEIF
{
    ...
    * Standard specification: http://standards.iso.org/ittf/PubliclyAvailableStandards/c066067_ISO_IEC_23008-12_2017.zip
    */
    ...
    public:
        ...
        static void Destroy(Writer* interface);
        ...
        */
        ...
        /**
        * Set the major brand.
        * Calling this is possible only if the file type box was not already written (OutputConfig.progressiveFile = true).
        ...
        */
         ...
         *                               The Id must be provided along media data Data when feeding encoded data to inform what decoder 
         *                               configuration should be used to decode that media data.
         ...
         * @param data        [in]  Data struct. Ownership of the data will not be transferred. It must be freed by the caller. This can be done
         *                          immediately after the call.
         * @param mediaDataId [out] MediaDataId for the added data. This can then be for example referred by addImage() when creating images from the added data.
        ...
        * @param imageId       [in]  ImageId of the image to link metadata to.
        * @return ErrorCode: OK, UNINITIALIZED, INVALID_ITEM_ID or INVALID_MEDIADATA_ID
        */
        virtual ErrorCode addMetadata(const MediaDataId& mediaDataId, const ImageId& imageId) = 0;
        ...
        * from the auxiliary image to the master image must be also present. The reference is created by using method addAuxiliaryReference().
        ...
        * @param isTransformative [in]  True if this is a transformative property, false if it is a descriptive property.
        * @param propertyId       [out] PropertyId of the added property, to be used as a parameter of associateProperty().
        * @return ErrorCode: OK or UNINITIALIZED
        */
        ...
        * @param timeBase      [in] Rational value of number of time units per second used for this image sequence (usually 1 / timescale)
        * @param constraints   [in] CodingConstraints for this image sequence. See CodingConstraints struct definition for more info.
        * @param id            [out] SequenceId identifier of the added sequence. This is not necessarily the same as the corresponding track ID in the file.
        * @return ErrorCode: OK or UNINITIALIZED
        */
         ...
         * @return ErrorCode: OK, UNINITIALIZED, INVALID_SEQUENCE_ID, INVALID_MEDIADATA_ID, INVALID_FUNCTION_PARAMETER or INVALID_MEDIA_FORMAT
         */
        ...
        * @param imageId      [out] SequenceImageId of the image to link metadata to.
        * @return ErrorCode: OK, UNINITIALIZED, INVALID_SEQUENCE_ID, INVALID_SEQUENCE_IMAGE_ID or INVALID_MEDIADATA_ID
        */
        virtual ErrorCode addMetadata(const MediaDataId& mediaDataId, const SequenceId& sequenceId, const SequenceImageId& imageId) = 0;
        ...
        */
         ...
         * @param sequenceId            [in]  SequenceId of the Image Sequence for which the auxiliary Image Sequence is added.
         * @return ErrorCode: OK, UNINITIALIZED or INVALID_SEQUENCE_ID
         */
        ...
        *       as image (=sample) specific information is needed (else none of the samples of sequece will be marked as equivalence).
        ...
        * @param offset              [in]  Optional: In case equivalence image item doesn't match give SequenceImageId timing on image sequence timeline
        *                                  this offset value can be added (see HEIF specification "6.8	Relating an untimed item to a timed sequence" for details)
        *                                  to indicate this.
        * @return ErrorCode: OK, UNINITIALIZED, INVALID_SEQUENCE_IMAGE_ID or INVALID_GROUP_ID
        */
        virtual ErrorCode addToEquivalenceGroup(const GroupId& equivalenceGroupId, const SequenceImageId& id, const EquivalenceTimeOffset& offset = {0, 1 << 8}) = 0;
        ...
        * @param timeBase      [in] Rational value of number of time units per second used for this video track (usually 1 / timescale)
        * @param constraints   [in] CodingConstraints for this video sequence. See CodingConstraints struct definition for more info.
        * @param id            [out] Identifier of the added track. This is not necessary same the corresponding track ID in the file.
        * @return ErrorCode: OK, UNINITIALIZED
        */
        virtual ErrorCode addVideoTrack(const Rational& timeBase, const CodingConstraints& constraints, SequenceId& id) = 0;
        ...
        * @return ErrorCode: OK, UNINITIALIZED, INVALID_SEQUENCE_ID, INVALID_MEDIADATA_ID, INVALID_FUNCTION_PARAMETER or INVALID_MEDIA_FORMAT
        */
        virtual ErrorCode addVideo(const SequenceId& id, const MediaDataId& mediaDataId, const SampleInfo& sampleInfo) = 0;

        /**
        * Add a new audio (track with 'soun' handler type) to the file.
        * @param timeBase [in] Rational value of number of time units per second used for this audio track (usually 1 / samplerate)
        * @param config   [in] AudioParams for this audio track. See AudioParams struct definition for more info.
        * @param id       [out] SequenceId identifier of the added track. This is not necessary same the corresponding track ID in the file.
        * @return ErrorCode: OK, UNINITIALIZED
        */
        ...
        * @return ErrorCode:  OK, UNINITIALIZED, INVALID_SEQUENCE_ID, INVALID_MEDIADATA_ID, INVALID_FUNCTION_PARAMETER or INVALID_MEDIA_FORMAT
        */
        virtual ErrorCode addAudio(const SequenceId& id, const MediaDataId& mediaDataId, const SampleInfo& sampleInfo) = 0;
